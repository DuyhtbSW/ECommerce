...
namespace ECommerce.Service
{
    public class VnPayService : IVnPayService
    {
        ...
        public string CreatePaymentUrl(HttpContext context, VnPaymentRequestModel model)
        {
            ...
            vnpay.AddRequestData("vpn_Version", _config["VnPay:Version"]);
            vnpay.AddRequestData("vpn_Command", _config["VnPay:Command"]);
            vnpay.AddRequestData("vpn_TmnCode", _config["VnPay:TmnCode"]);
            vnpay.AddRequestData("vpn_Amount",(model.Amount*100).ToString());
